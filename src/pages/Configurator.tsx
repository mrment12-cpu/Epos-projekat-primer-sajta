        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            >
              ...
              {categoryInfo.map(({ key, label, icon: Icon }, idx) => (
                <motion.div
                  key={key}
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    {selected[key] && (
                      <motion.span
                        ...
                        className="ml-auto text-xs text-success flex items-center gap-1"
                      >
            ...
            >
              <div className="sticky top-20 space-y-4">
                <motion.div variants={scaleUp} className="glass rounded-xl p-5">
                ...
                <div className="glass rounded-xl p-5">
                  ...
                  <AnimatePresence mode="wait">
                    {issues.length > 0 ? (
                      <motion.div key="issues" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} className="space-y-2">
                        {issues.map((issue, i) => (
                          <motion.div
                            key={i}
                      ...
                      <motion.div key="ok" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} className="flex items-center gap-2 text-sm text-success">
                        <Check className="w-4 h-4" />
                        <span>Sve komponente su kompatibilne!</span>
                      </motion.div>
                    ) : (
                      <motion.div key="empty" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} className="flex items-center gap-2 text-sm text-muted-foreground">
